...
export const BROWSER_IPC_CHANNELS = {
  ENSURE: 'browser:ensure', SET_BOUNDS: 'browser:set-bounds', HIDE: 'browser:hide', NAVIGATE: 'browser:navigate',
  BACK: 'browser:back', FORWARD: 'browser:forward', RELOAD: 'browser:reload', NEW_TAB: 'browser:new-tab',
  CLOSE_TAB: 'browser:close-tab', SELECT_TAB: 'browser:select-tab', OBSERVE: 'browser:observe', CLICK: 'browser:click',
  TYPE: 'browser:type', SCROLL: 'browser:scroll', SCREENSHOT: 'browser:screenshot', STOP: 'browser:stop',
  TAKEOVER: 'browser:takeover', RESUME: 'browser:resume', STATE_CHANGED: 'browser:state-changed', OPEN_REQUEST: 'browser:open-request',
} as const
